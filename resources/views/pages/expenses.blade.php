...
<div id="view-biaya" class="space-y-4">
          ...
          <div class="bg-white border border-slate-100 rounded-3xl p-5 shadow-sm">
            <div class="relative">
              ...
              <input type="text" id="expenseSearch" oninput="renderExpenses()" class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#C00000] focus:bg-white outline-none rounded-xl text-sm transition-all" placeholder="Cari ID CODE atau rincian pengeluaran...">
            </div>
          </div>
            ...
            <div class="overflow-x-auto">
              <table class="w-full border-collapse text-left text-sm">
                <thead class="bg-slate-50 text-slate-500 text-xs font-bold uppercase tracking-wider border-b border-slate-100">
                  <tr><th class="p-4 pl-6">ID CODE</th><th class="p-4">Tanggal</th><th class="p-4">Kategori</th><th class="p-4">Deskripsi</th><th class="p-4 text-right">Jumlah (Rp)</th><th class="p-4 pr-6 text-center">Aksi</th></tr>
                </thead>
